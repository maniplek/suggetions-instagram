...
import Suggetions from "./components/suggetionsComp/Suggetions";

const App = () => {
  const suggetions = [
    {
      profilePicture: "saschafirtina.jpg",
    ...
    {
      profilePicture: "marin.ivankovic.jpg",
      username: "marin.ivankovic",
      name: "Marin",
      biography:
        "Just a guy, who decided to go for it\n—\n📍 🇭🇷 living in Berlin 🇩🇪\n🚀 Startups | Fashion | Fitness\n👻 Snapchat: mrn_kovic",
      followers: 26561,
      following: 454,
      userId: 274836879,
      numPosts: 808,
    ...
    {
      profilePicture: "chapteronecoffeeberlin.jpg",
      username: "chapteronecoffeeberlin",
      name: "Chapter One Coffee Berlin",
      biography:
        "Mittenwalder Str.30, 10961 Berlin, mo-sa: 9.00-18.00/so: 11.00-18.00",
      followers: 2731,
      following: 1199,
      isPrivate: "",
      userId: 1534537685,
  ...
  return (
    <div className="App">
      <Header />
      <Suggetions suggetions={suggetions} />
    </div>
  );
};
